...
# ============================================================================
# CONFIGURATION SECTION - Unified MIRE + WanVideo Workflow
# ============================================================================
...
# ============================================================================
# MIRE CUSTOM MODEL ARRAYS (for non-standard directories)
# ============================================================================
...
function provisioning_start() {
    ...
    # Standard model directories (MIRE workflow)
    ...
    # Rename files for workflow compatibility (MIRE specific)
...
function provisioning_post_process() {
    ...
    # Rename CLIP Vision model for MIRE
...
function provisioning_print_header() {
    ...
    printf "Unified Workflow Setup: MIRE + WanVideo VACE\n"
...
function provisioning_print_end() {
    ...
    printf "============================================\n"
    printf "MIRE Workflow Models Installed:\n"
    printf "  - Checkpoints: ${COMFYUI_DIR}/models/checkpoints/\n"
    printf "  - AnimateDiff: ${COMFYUI_DIR}/models/animatediff_models/\n"
    printf "  - IP-Adapter: ${COMFYUI_DIR}/models/ipadapter/\n"
    printf "  - ControlNet: ${COMFYUI_DIR}/models/controlnet/\n"
    printf "  - LoRAs: ${COMFYUI_DIR}/models/loras/\n"
    printf "\n"
    printf "WanVideo Workflow Models Installed:\n"
    ...
    printf "============================================\n\n"
    printf "You can now run both MIRE and WanVideo workflows!\n\n"
}
